...
export default function NubankVipSystem() {
  ...
  // =========================
   const VALID_KEYS = useMemo(() => [
    // --- ORIGINAIS & ESPECIAIS ---
    "PAINELVIP-Q9XP4KZ8M27F", "PAINELVIP-A9F7Q2KX8M4ZP", "NUBANK-ZXP19FQKM248A6G", "NUBANK-XC1VB2NM3QW4ER5", "NUBANK-MOD", "MAJESTIC-X4KQFZ12MP98A", "PAINELVIP-7Q9FZK2M8XP4A", "256", "MAJESTIC-PRO", "CLISHA-091", "ACCESS-FULL", "ACCESS-PREMIUM",
